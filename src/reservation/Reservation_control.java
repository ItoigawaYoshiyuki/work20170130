...
/////////指定した施設の 概要表示
    public String facilityexplanation(String facility){
	    ...
	    if ( flagLogin){ // ログインしていた場合
	   	     switch(facility){//施設それぞれの概要
		
		       case "小ホール":
                  res =  "小ホール：　1階にある小さいスペースですです。講演会など多目的に利用できます。有料施設です。\n";
                  break;
	           
               case "大会議室1":
                   res="大会議室1：　1階にある大きな会議室です。500人程度入ることができます。有料施設です。\n";
                   break;
          
		       case "大会議室2":
                   res= "大会議室2：　2階にある大きな会議室です。400人程度入ることができます。有料施設です。\n";
                   break;
		
		       case  "小会議室1":
                   res="小会議室1：　1階にある小さな会議室です。50人程度入ることができます。無料施設です。\n";
                   break;
		
		       case "小会議室2":
                   res=   "小会議室2：　2階にある小さな会議室です。45人程度入ることができます。無料施設です。\n";                  
                   break;
		
		
		       case "小会議室3":
                  res=    "小会議室3：　3階にある小さな会議室です。40人程度入ることができます。無料施設です。\n";
                  break;
		
		       case"小会議室4":
                  res=    "小会議室4：　4階にある小さな会議室です。35人程度入ることができます。無料施設です。\n";
                  break;
		
		       case"小会議室5":
                  res=    "小会議室5：　5階にある小さな会議室です。30人程度入ることができます。無料施設です。\n";
                  break;
		
		       case"小会議室6":
        	      res=     "小会議室6：　6階にある小さな会議室です。25人程度入ることができます。無料施設です。\n";
        	      break;
		     }
        }else { // ログインしていない場合
            res = "ログインしてください";
                            ...
                            res = "開始時刻と終了時刻が同じです";
                             ...
                             try {
                                  ...
                                  while(rs.next()){
                                       ...
                                       if  (start.compareTo(st)==0 && end.compareTo(et)==0){ //レコードの開始時刻＝新規の開始時刻　AND　新規の終了時刻＝レコードの終了時刻
